...
if (window.innerWidth <= 768) {
    console.log('📱 Preview de Excavations deshabilitado en móvil');
    
    // Sobrescribir la función ex_openPreview para que no haga nada en móvil
    const originalExOpenPreview = window.ex_openPreview;
    window.ex_openPreview = function() {
